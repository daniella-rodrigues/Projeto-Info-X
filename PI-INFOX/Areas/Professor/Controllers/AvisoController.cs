...
namespace PI_INFOX.Areas.Professor.Controllers
{
    public class AvisoController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DisciplinaID = new SelectList(db.Usuario, "DisciplinaID", "DisciplinaID");
            return View();
        }
        ...
        public ActionResult Create(basAviso basaviso)
        {
            ...
            ViewBag.DisciplinaID = new SelectList(db.Usuario, "DisciplinaID", "DisciplinaID", basaviso.DisciplinaID);
            return View(basaviso);
        }
