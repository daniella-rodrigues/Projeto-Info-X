...
namespace PI_INFOX.Areas.Admin.Controllers
{
    public class VagasController : Controller
    {
        ...
        {
            ViewBag.matriculaInstituicaoID = new SelectList(db.Instituicao, "matriculaInstituicaoID", "login");
            return View();
        }
        ...
        public ActionResult Create(basVaga_Estagio_Emprego basvaga_estagio_emprego)
        {
            ...
            ViewBag.matriculaInstituicaoID = new SelectList(db.Instituicao, "matriculaInstituicaoID", "login", basvaga_estagio_emprego.matriculaInstituicaoID);
            return View(basvaga_estagio_emprego);
        }
